...
export function sackGeometry(rng, w = 0.5, h = 0.17, d = 0.3, opts = {}) {
  const { variant = 0, box = 3.1, lump = 1, seg = 16, rings = 9 } = opts;
  // 16 x 9 = 256 triangles. The Lp-ball is nearly flat over most of its surface,
  // so the extra rings of a 20 x 12 sphere (440 tris) only resolve on the tied
  // ends — and an emplacement is thirty bags.
